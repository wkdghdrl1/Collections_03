...
public class List_01 {
	public static void main(String[] args) {
		...
		// int, char, float, long, double과 같은
		// 기본 자료형은 포할 할 수 없다
		// List<int> int
		...
		/*
		 * ArrayList는 List 자료구조 중 가장 많이 사용되고
		 * 내부적으로 가장 단순한 구조이며
		 * 기본 배열구조와 매우 유사하게 작동
		 * 
		 * LinkedList는 List 자료구조 중 가장 복잡한 구조이고
		 * 리스트 중간중간에 추가, 삭제가 자주 일어나는 경우
		 * 매우 효율적으로 작동되는 형식
		 * 
		 * 
		 * Vector는 쓰레드프로젝트에서 항상 
		 * 순차적으로 실행되어 안정성이 보장된다.
		 */
